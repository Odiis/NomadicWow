...
insert  into `account`(`id`,`username`,`sha_pass_hash`,`sessionkey`,`v`,`s`,`token_key`,`email`,`reg_mail`,`joindate`,`last_ip`,`failed_logins`,`locked`,`lock_country`,`last_login`,`online`,`expansion`,`mutetime`,`mutereason`,`muteby`,`locale`,`os`,`recruiter`,`on_trial`,`trial_end`) values (1,'ADMIN','8301316D0D8448A34FA6D0C6BF1CBFA2B4A1A93A','','','','','','','2013-10-28 00:00:00','127.0.0.1',0,0,'00','0000-00-00 00:00:00',0,3,0,'','',0,'',0,0,1);
...
insert  into `realmlist`(`id`,`name`,`address`,`localAddress`,`localSubnetMask`,`port`,`icon`,`flag`,`timezone`,`allowedSecurityLevel`,`population`,`gamebuild`) values (1,'NomadicWow Ultimate Repack 4.3.4','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,2,1,0,0,15595);
